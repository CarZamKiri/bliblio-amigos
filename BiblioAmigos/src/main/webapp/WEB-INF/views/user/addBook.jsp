...
<head>
    ...
    <script>
        $(function() {
            function setupAutocomplete(fieldId, type) {
                $("#" + fieldId).autocomplete({
                    source: function(request, response) {
                        $.ajax({
                            url: "${pageContext.request.contextPath}/AutocompleteServlet",
                            data: {
                                term: request.term,
                                type: type
                            },
            ...
            setupAutocomplete("autor", "autor");
            setupAutocomplete("genero", "genero");
            setupAutocomplete("editorial", "editorial");
            setupAutocomplete("categoria", "categoria");
        });
    </script>
</head>
<body>
<div class="container">
    <h1>Agregar Libro</h1>
    <form action="${pageContext.request.contextPath}/newBookServlet" method="post">
